...
impl Galaxy{
    pub fn new()->Galaxy{
        ...
        let obj: Galaxy = Galaxy{name:name, distance:0.0 as f64, velocity:0.0 as f64};
        return obj;
    }
    
    pub fn create(name:String, distance:f64, velocity:f64)->Galaxy{
        //! Create a new galaxy object from the given data.
        let obj: Galaxy = Galaxy { name: name, distance: distance, velocity: velocity };
        return obj;
    }
...
impl Output{
    pub fn new()->Output{
        ...
        let obj: Output = Output{h0:0.0 as f64, age:0.0 as f64};
        return obj;
    }
